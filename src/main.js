...
const earth 	= new Planet	("Earth", 	"blue", 	5.10, 	110, 	0.013, 	sun)
const mars 		= new Planet	("Mars", 	"red", 		3.00, 	140, 	0.006, 	sun)
const jupiter 	= new Planet	("Jupiter", "orange", 	20.42, 	220, 	0.0015, sun)
const saturn 	= new Planet	("Saturn", 	"#a88b6d", 	17.23, 	320, 	0.0010, sun, true)
const uranus 	= new Planet	("Uranus", 	"#9fc4ca", 	7.30, 	400, 	0.0003, sun)
const neptune 	= new Planet	("Neptune", "#3454df", 	7.07, 	450, 	0.0006, sun)
const moon 		= new Moon		("Moon", 	"#ffffff", 	1.00, 	10, 	0.013, 	earth)
